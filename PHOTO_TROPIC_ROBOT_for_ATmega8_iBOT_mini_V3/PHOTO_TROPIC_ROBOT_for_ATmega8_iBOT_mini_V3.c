// Project name : PHOTO_TROPIC_ROBOT_for_ATmega8_iBOT_mini_V3
// Compile Date : 29/03/2013 Time : (11:40)
...
/* Program for "PHOTO_TROPIC_ROBOT/Robot tries to follow the light falling on the 2 IR Sensors connected on PC0 and PC3" 
