// Project name : PHOTO_PHOBIC_ROBOT_for_ATmega8_iBOT_mini_V3
// Compile Date : 29/03/2013 Time : (11:30)
...
/* Program for "PHOTO_PHOBIC_ROBOT/Robot tries to ignore the light falling on the 2 IR Sensors connected on PC0 and PC3" 
